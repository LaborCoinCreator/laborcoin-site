# LaborCoin Website Revision 7 Candidate

This site package preserves the latest approved visual design while migrating functionality and content to the seven-contract Revision 7 equal-holder architecture.
...
- Updated contract labels and ABIs for LABR V3, Exchange V6, LaborVote V9, Registration V6, and Governance V15.
...
The latest approved replacement design and `style.css` are preserved. Exchange receives additional identity and dividend status rows and buttons using existing classes. Onboarding, FAQ, home, and disclaimer content reflects Revision 7. No new global visual redesign is introduced.
